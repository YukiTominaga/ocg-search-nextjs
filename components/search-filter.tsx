      ...
      <DialogContent className="sm:max-w-[425px] h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="grid gap-4 py-4 px-1">
            <div>
              <h3 className="font-medium text-sm mb-3 text-gray-700">カード種類</h3>
            ...
            <div>
              <h3 className="font-medium text-sm mb-3 text-gray-700">属性</h3>
              <div className="space-y-2">
                <div className="grid grid-cols-3 gap-1.5">
            ...
            <div>
              <h3 className="font-medium text-sm mb-3 text-gray-700">種族</h3>
              <div className="space-y-2">
                <div className="grid grid-cols-3 gap-1.5">
            ...
            <div>
              <h3 className="font-medium text-sm mb-3 text-gray-700">レベル・ランク・LINK</h3>
              <div className="space-y-2">
                <div className="grid grid-cols-7 gap-1.5">
                  <Toggle pressed={filters.level_rank_link_0} onPressedChange={handleToggle('level_rank_link_0')} className={`${toggleButtonClass(filters.level_rank_link_0)} flex items-center justify-center`}>
                    <span>0</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_1} onPressedChange={handleToggle('level_rank_link_1')} className={`${toggleButtonClass(filters.level_rank_link_1)} flex items-center justify-center`}>
                    <span>1</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_2} onPressedChange={handleToggle('level_rank_link_2')} className={`${toggleButtonClass(filters.level_rank_link_2)} flex items-center justify-center`}>
                    <span>2</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_3} onPressedChange={handleToggle('level_rank_link_3')} className={`${toggleButtonClass(filters.level_rank_link_3)} flex items-center justify-center`}>
                    <span>3</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_4} onPressedChange={handleToggle('level_rank_link_4')} className={`${toggleButtonClass(filters.level_rank_link_4)} flex items-center justify-center`}>
                    <span>4</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_5} onPressedChange={handleToggle('level_rank_link_5')} className={`${toggleButtonClass(filters.level_rank_link_5)} flex items-center justify-center`}>
                    <span>5</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_6} onPressedChange={handleToggle('level_rank_link_6')} className={`${toggleButtonClass(filters.level_rank_link_6)} flex items-center justify-center`}>
                    <span>6</span>
                  </Toggle>
                </div>
                <div className="grid grid-cols-7 gap-1.5">
                  <Toggle pressed={filters.level_rank_link_7} onPressedChange={handleToggle('level_rank_link_7')} className={`${toggleButtonClass(filters.level_rank_link_7)} flex items-center justify-center`}>
                    <span>7</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_8} onPressedChange={handleToggle('level_rank_link_8')} className={`${toggleButtonClass(filters.level_rank_link_8)} flex items-center justify-center`}>
                    <span>8</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_9} onPressedChange={handleToggle('level_rank_link_9')} className={`${toggleButtonClass(filters.level_rank_link_9)} flex items-center justify-center`}>
                    <span>9</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_10} onPressedChange={handleToggle('level_rank_link_10')} className={`${toggleButtonClass(filters.level_rank_link_10)} flex items-center justify-center`}>
                    <span>10</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_11} onPressedChange={handleToggle('level_rank_link_11')} className={`${toggleButtonClass(filters.level_rank_link_11)} flex items-center justify-center`}>
                    <span>11</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_12} onPressedChange={handleToggle('level_rank_link_12')} className={`${toggleButtonClass(filters.level_rank_link_12)} flex items-center justify-center`}>
                    <span>12</span>
                  </Toggle>
                  <Toggle pressed={filters.level_rank_link_13} onPressedChange={handleToggle('level_rank_link_13')} className={`${toggleButtonClass(filters.level_rank_link_13)} flex items-center justify-center`}>
                    <span>13</span>
                  </Toggle>
                </div>
              </div>
            ...
            <div>
              <h3 className="font-medium text-sm mb-3 text-gray-700">魔法・罠の種類</h3>
              <div className="space-y-2">
                <div className="grid grid-cols-3 gap-1.5">
            ...
            <div>
              <h3 className="font-medium text-sm mb-3 text-gray-700">能力・その他</h3>
              <div className="space-y-2">
                <div className="grid grid-cols-3 gap-1.5">
